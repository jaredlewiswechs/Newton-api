...
class ControlFlowAnalyzer:
    ...
    @classmethod
    def analyze(cls, code: str, language: SourceLanguage) -> list[UnreachableState]:
    ...
    @classmethod
    def _check_contradiction(cls, new_guard: str, existing_guards: list[tuple[str, int]]) -> Optional[str]:
    ...
    def _is_negation(cls, a: str, b: str) -> bool:
        ...
        for pattern, neg_pattern in negation_pairs:
            match_a = re.match(pattern, a)
            match_b = re.match(neg_pattern, b)
