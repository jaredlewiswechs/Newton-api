# Newton OS Documentation

Welcome to the Newton OS documentation. Newton is an AI safety layer that verifies intent before execution.
...
- [Core Endpoints](endpoints/core.md) - Verify, Analyze, Compile, Ground
- [Audit & Security](endpoints/audit.md) - Ledger, Sign, Chain verification
- [Metadata](endpoints/metadata.md) - Health, Constraints, Methods
...
| [Hosted API](https://parcri.net) | Sign up for instant access |
